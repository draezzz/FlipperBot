...
const int flipBtnPin = A4;   // new add for flip

void setup() {
  // new add for flip
  pinMode(flipBtnPin, INPUT_PULLUP);   // reads HIGH when open, LOW when pressed
...
void loop() {
  ...
  int btn = digitalRead(flipBtnPin);
